...
jsonpath = "data/RuNNE_struct/test.json" # Здесь выбираем, куда будет сохраняться датасет, и под каким именем
    ...
    for entity in entities:
        ...
        for span in sentence_spans:
            ...
            if entity["span"] in context and entity["start"] >= start and entity["end"] <= end:
                context = context[ : entity["start"] - start] + "[" + entity["span"] + " | " + tag + "]" + context[entity["end"] - end : ]
