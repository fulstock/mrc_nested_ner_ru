...
Ниже представлена подсказка "5 самых частотных компонентов сущностей", взятая на данных `NEREL-bio`. Сгенерировано автоматически на основе обучающего набора данных (см. `prompts\bio_mfc.py`)
