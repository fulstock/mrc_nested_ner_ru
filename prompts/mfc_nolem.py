...
jsonpath = "data/RuNNE_mfcnl10/test.json" # Здесь выбираем, куда будет сохраняться датасет, и под каким именем
...
for tag, entities in tag_to_spans.items():
    ...
    tag_to_spans[tag] = Counter(tag_to_spans[tag]).most_common(10)
