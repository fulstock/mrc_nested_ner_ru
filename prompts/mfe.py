...
brat2mrc_parser.add_argument('--most_common', '--N', '-n', type = int, default = 10, help = "This amount (N) of most common entities is retrieved to the prompt. Default: N = 10")
...
for entity in all_entities:
    tag_to_spans[entity["tag"]].append(entity["span"])
